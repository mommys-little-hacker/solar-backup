...
MSG_LOCKED="Another instance of this script is running aleady, see the lockfile"
MSG_NO_BACKEND="No such backend"
MSG_NOT_IMPLEMENTED="Requested feature not implemented"

MSG_FILES_START="Starting file transfer"
...
MSG_CRON_SKIP="Skipping crontab backup"
MSG_CRON_FAIL="Crontab backup failed"

MSG_DB_START="Starting DB backup"
MSG_DB_FINISH="DB backup finished"
